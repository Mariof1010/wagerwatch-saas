...
namespace WagerWatch.Migrations
{
    ...
    [Migration("20250710211459_AddUserTimeZone")]
            ...
            modelBuilder.Entity("WagerWatch.Models.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AwayTeamId = 2,
                            GameTime = new DateTime(2025, 7, 10, 23, 14, 58, 137, DateTimeKind.Utc).AddTicks(7068),
                            HomeTeamId = 1,
                            Sport = "NFL",
                            Status = "Scheduled"
                        },
                        new
                        {
                            Id = 2,
                            AwayTeamId = 4,
                            GameTime = new DateTime(2025, 7, 11, 3, 14, 58, 137, DateTimeKind.Utc).AddTicks(7068),
                            HomeTeamId = 3,
                            Sport = "NFL",
                            Status = "Scheduled"
                        },
                        new
                        {
                            Id = 3,
                            AwayTeamId = 6,
                            GameTime = new DateTime(2025, 7, 11, 1, 14, 58, 137, DateTimeKind.Utc).AddTicks(7068),
                            HomeTeamId = 5,
                            Sport = "NBA",
                            Status = "Scheduled"
                        },
                        new
                        {
                            Id = 4,
                            AwayTeamId = 8,
                            GameTime = new DateTime(2025, 7, 11, 5, 14, 58, 137, DateTimeKind.Utc).AddTicks(7068),
                            HomeTeamId = 7,
                            Sport = "NBA",
                            Status = "Scheduled"
                        });
            ...
            modelBuilder.Entity("WagerWatch.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 10, 21, 14, 58, 138, DateTimeKind.Utc).AddTicks(1335),
